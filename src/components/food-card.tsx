    ...
    >
      <a href="#" className="relative">
        ...
        {food.promotion === 'discount' && (
          <Badge className="absolute top-0 left-0 rounded-tl-lg rounded-tr-none  rounded-bl-none rounded-br-lg px-3 py-1 bg-red-400 text-white">
            <span className="text-sm">%</span>
          </Badge>
        )}

        {food.promotion === '1+1' && (
          <Badge className="absolute top-0 left-0 rounded-tl-lg rounded-tr-none  rounded-bl-none rounded-br-lg px-3 py-1 bg-violet-600 text-white">
